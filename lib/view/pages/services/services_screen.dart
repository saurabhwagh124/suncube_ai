  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                  ...
                  flexibleSpace: Container(
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: [
                          const Color(0xFF060C09).withOpacity(0.95),
                          const Color(0xFF060C09).withOpacity(0.7),
                        ],
                      ),
                    ),
                  ),
      ...
      body: LiquidBackground(
        child: SafeArea(
          top: !widget.showAppBar, // Only apply SafeArea if no custom AppBar
          child: SingleChildScrollView(
            physics: const BouncingScrollPhysics(),
            padding: EdgeInsets.fromLTRB(
              16.w,
              widget.showAppBar ? 100.h : 20.h,
              16.w,
              40.h,
            ),
            child: Column(
