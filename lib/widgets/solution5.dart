...
class Solution5Page extends StatelessWidget {
  @override
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          ElevatedButton(onPressed: () {}, child: Text('Portal Login')),
          ElevatedButton(
            onPressed: () {},
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 10),
                    Text(
                      'Your Energy Has a Pattern. We Help You See It.',
                      style: TextStyle(
                        fontSize: 32,
                        fontWeight: FontWeight.bold,
                        color: Colors.white,
                    ...
                    SizedBox(height: 10),
                    Text(
                      'From sun to storage, Suncube AI reveals how your system behaves — and how to prepare smarter.',
                      style: TextStyle(fontSize: 18, color: Colors.white),
                    ),
                    SizedBox(height: 20),
                    ElevatedButton(
                      onPressed: () {},
                      child: Text('See Predictive Dashboard'),
                      style: ElevatedButton.styleFrom(
                        foregroundColor: Colors.blue,
                        backgroundColor: Colors.white,
                      ),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text('Dust accumulation detected on panels 3-7'),
                    ...
                    children: [
                      ...
                      Card(
                        child: Padding(
                          padding: const EdgeInsets.all(16.0),
                          child: Column(
                            children: [Text('Panel Group B'), Text('Critical')],
                          ),
                        ),
                      ),
                      Card(
                        child: Padding(
                          padding: const EdgeInsets.all(16.0),
                          child: Column(
                            children: [Text('Battery Line 1'), Text('Normal')],
                          ),
                        ),
                      ),
                      Card(
                        child: Padding(
                          padding: const EdgeInsets.all(16.0),
                          child: Column(
                            children: [Text('Battery Line 2'), Text('Warning')],
                          ),
                        ),
                      ),
                      Card(
                      ...
                      Card(
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              Text('CSV Export'),
                              Text('Raw data export for spreadsheet analysis'),
                      ...
                      Card(
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              Text('Excel Export'),
                              Text('Formatted report with charts and analysis'),
                              Text('Sheets: 5'),
